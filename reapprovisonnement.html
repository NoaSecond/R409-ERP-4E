...
<head>
    ...
    <title>R409 | Réapprovisionnement</title>
    <meta name="title" content="R409 | Réapprovisionnement">
    ...
    <link rel="stylesheet" href="css/reapprovisionnement.css">
    <link rel="stylesheet" href="css/responsive/responsive-reapprovisionnement.css">
    <!--JS-->
    <script type="text/javascript" src="./js/loader.js"></script>
    <script type="text/javascript" src="./js/menu.js"></script>
    <script type="text/javascript" src="./js/reapprovisionnement.js"></script>
    ...
    <main>        
        ...
        <section id="content">
            <div id="contentLeft">
                ...
                <label class="switch">
                    <a class="leftSwitchText">Produits</a>
                    <input type="checkbox" id="inputCarburantsProduits"/>
            ...
            <div id="contentRight">
                <label class="switch">
                    <a class="leftSwitchText">Panier</a>
                    <input type="checkbox" id="inputPanierCommandes"/>
                    <span class="slider round"></span>
                    <a class="rightSwitchText">Commandes</a>
                </label>
                <div id="panierWrap">
                    <div class="produitPanier">
                        ...
                        <div>
                            <a>99 €</a>
                            <input type="number" name="qttProduit" value="10" min="10" max="99">
